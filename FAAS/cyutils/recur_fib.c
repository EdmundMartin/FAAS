...
#define __PYX_HAVE__recur_fib
#define __PYX_HAVE_API__recur_fib
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/*--- Type declarations ---*/
struct __pyx_obj_9recur_fib___pyx_scope_struct__rec_fib;
...
/* Module declarations from 'recur_fib' */
static PyTypeObject *__pyx_ptype_9recur_fib___pyx_scope_struct__rec_fib = 0;
#define __Pyx_MODULE_NAME "recur_fib"
int __pyx_module_is_main_recur_fib = 0;

/* Implementation of 'recur_fib' */
...
static const char __pyx_k_rec_fib[] = "rec_fib";
static const char __pyx_k_recur_fib[] = "recur_fib";
static const char __pyx_k_recur_fib_pyx[] = "recur_fib.pyx";
...
static PyObject *__pyx_n_s_rec_fib;
static PyObject *__pyx_n_s_recur_fib;
static PyObject *__pyx_kp_s_recur_fib_pyx;
static PyObject *__pyx_n_s_send;
static PyObject *__pyx_n_s_test;
static PyObject *__pyx_n_s_throw;
static PyObject *__pyx_pf_9recur_fib_rec_fib(CYTHON_UNUSED PyObject *__pyx_self, long __pyx_v_n); /* proto */
static PyObject *__pyx_tp_new_9recur_fib___pyx_scope_struct__rec_fib(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
static PyObject *__pyx_tuple_;
static PyObject *__pyx_codeobj__2;
static PyObject *__pyx_gb_9recur_fib_2generator(__pyx_CoroutineObject *__pyx_generator, PyObject *__pyx_sent_value); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_9recur_fib_1rec_fib(PyObject *__pyx_self, PyObject *__pyx_arg_n); /*proto*/
static PyMethodDef __pyx_mdef_9recur_fib_1rec_fib = {"rec_fib", (PyCFunction)__pyx_pw_9recur_fib_1rec_fib, METH_O, 0};
static PyObject *__pyx_pw_9recur_fib_1rec_fib(PyObject *__pyx_self, PyObject *__pyx_arg_n) {
  long __pyx_v_n;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("rec_fib (wrapper)", 0);
  assert(__pyx_arg_n); {
    __pyx_v_n = __Pyx_PyInt_As_long(__pyx_arg_n); if (unlikely((__pyx_v_n == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 3, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("recur_fib.rec_fib", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9recur_fib_rec_fib(__pyx_self, ((long)__pyx_v_n));
...
static PyObject *__pyx_pf_9recur_fib_rec_fib(CYTHON_UNUSED PyObject *__pyx_self, long __pyx_v_n) {
  struct __pyx_obj_9recur_fib___pyx_scope_struct__rec_fib *__pyx_cur_scope;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("rec_fib", 0);
  __pyx_cur_scope = (struct __pyx_obj_9recur_fib___pyx_scope_struct__rec_fib *)__pyx_tp_new_9recur_fib___pyx_scope_struct__rec_fib(__pyx_ptype_9recur_fib___pyx_scope_struct__rec_fib, __pyx_empty_tuple, NULL);
  if (unlikely(!__pyx_cur_scope)) {
    __pyx_cur_scope = ((struct __pyx_obj_9recur_fib___pyx_scope_struct__rec_fib *)Py_None);
  ...
  {
    __pyx_CoroutineObject *gen = __Pyx_Coroutine_New((__pyx_coroutine_body_t) __pyx_gb_9recur_fib_2generator, (PyObject *) __pyx_cur_scope, __pyx_n_s_rec_fib, __pyx_n_s_rec_fib, __pyx_n_s_recur_fib); if (unlikely(!gen)) __PYX_ERR(0, 3, __pyx_L1_error)
...
static PyObject *__pyx_gb_9recur_fib_2generator(__pyx_CoroutineObject *__pyx_generator, PyObject *__pyx_sent_value) /* generator body */
{
  struct __pyx_obj_9recur_fib___pyx_scope_struct__rec_fib *__pyx_cur_scope = ((struct __pyx_obj_9recur_fib___pyx_scope_struct__rec_fib *)__pyx_generator->closure);
  PyObject *__pyx_r = NULL;
  long __pyx_t_1;
  long __pyx_t_2;
  long __pyx_t_3;
 ...
 */
    ...
    __pyx_t_4 = (__pyx_cur_scope->__pyx_v_a + __pyx_cur_scope->__pyx_v_b);
    __pyx_cur_scope->__pyx_v_a = __pyx_t_3;
    __pyx_cur_scope->__pyx_v_b = __pyx_t_4;
  }
 ...
 */
  ...
  __pyx_t_5 = __Pyx_PyInt_From_long(__pyx_cur_scope->__pyx_v_a); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 10, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_AddTraceback("rec_fib", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_L0:;
...
static struct __pyx_obj_9recur_fib___pyx_scope_struct__rec_fib *__pyx_freelist_9recur_fib___pyx_scope_struct__rec_fib[8];
static int __pyx_freecount_9recur_fib___pyx_scope_struct__rec_fib = 0;

static PyObject *__pyx_tp_new_9recur_fib___pyx_scope_struct__rec_fib(PyTypeObject *t, CYTHON_UNUSED PyObject *a, CYTHON_UNUSED PyObject *k) {
  PyObject *o;
  if (CYTHON_COMPILING_IN_CPYTHON && likely((__pyx_freecount_9recur_fib___pyx_scope_struct__rec_fib > 0) & (t->tp_basicsize == sizeof(struct __pyx_obj_9recur_fib___pyx_scope_struct__rec_fib)))) {
    o = (PyObject*)__pyx_freelist_9recur_fib___pyx_scope_struct__rec_fib[--__pyx_freecount_9recur_fib___pyx_scope_struct__rec_fib];
    memset(o, 0, sizeof(struct __pyx_obj_9recur_fib___pyx_scope_struct__rec_fib));
...
static void __pyx_tp_dealloc_9recur_fib___pyx_scope_struct__rec_fib(PyObject *o) {
  if (CYTHON_COMPILING_IN_CPYTHON && ((__pyx_freecount_9recur_fib___pyx_scope_struct__rec_fib < 8) & (Py_TYPE(o)->tp_basicsize == sizeof(struct __pyx_obj_9recur_fib___pyx_scope_struct__rec_fib)))) {
    __pyx_freelist_9recur_fib___pyx_scope_struct__rec_fib[__pyx_freecount_9recur_fib___pyx_scope_struct__rec_fib++] = ((struct __pyx_obj_9recur_fib___pyx_scope_struct__rec_fib *)o);
  } else {
    (*Py_TYPE(o)->tp_free)(o);
  }
}

static PyTypeObject __pyx_type_9recur_fib___pyx_scope_struct__rec_fib = {
  PyVarObject_HEAD_INIT(0, 0)
  "recur_fib.__pyx_scope_struct__rec_fib", /*tp_name*/
  sizeof(struct __pyx_obj_9recur_fib___pyx_scope_struct__rec_fib), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_9recur_fib___pyx_scope_struct__rec_fib, /*tp_dealloc*/
  0, /*tp_print*/
  0, /*tp_getattr*/
  0, /*tp_setattr*/
  #if PY_MAJOR_VERSION < 3
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_9recur_fib___pyx_scope_struct__rec_fib, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_rec_fib, __pyx_k_rec_fib, sizeof(__pyx_k_rec_fib), 0, 0, 1, 1},
  {&__pyx_n_s_recur_fib, __pyx_k_recur_fib, sizeof(__pyx_k_recur_fib), 0, 0, 1, 1},
  {&__pyx_kp_s_recur_fib_pyx, __pyx_k_recur_fib_pyx, sizeof(__pyx_k_recur_fib_pyx), 0, 0, 1, 0},
 ...
 */
  ...
  __pyx_codeobj__2 = (PyObject*)__Pyx_PyCode_New(1, 0, 5, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple_, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_recur_fib_pyx, __pyx_n_s_rec_fib, 3, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__2)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initrecur_fib(void); /*proto*/
PyMODINIT_FUNC initrecur_fib(void)
#else
PyMODINIT_FUNC PyInit_recur_fib(void); /*proto*/
PyMODINIT_FUNC PyInit_recur_fib(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_recur_fib(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("recur_fib", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_recur_fib) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "recur_fib")) {
      if (unlikely(PyDict_SetItemString(modules, "recur_fib", __pyx_m) < 0)) __PYX_ERR(0, 3, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_9recur_fib___pyx_scope_struct__rec_fib) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
  __pyx_type_9recur_fib___pyx_scope_struct__rec_fib.tp_print = 0;
  __pyx_ptype_9recur_fib___pyx_scope_struct__rec_fib = &__pyx_type_9recur_fib___pyx_scope_struct__rec_fib;
  /*--- Type import code ---*/
 ...
 * 	cdef long b
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9recur_fib_1rec_fib, NULL, __pyx_n_s_recur_fib); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_rec_fib, __pyx_t_1) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init recur_fib", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init recur_fib");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
